...
class NotificationTechnicianItem extends StatelessWidget {
  final String message;
  final String date;
  final int id;
  final String imagePerson;

  const NotificationTechnicianItem({super.key, required this.message, required this.date, required this.id, required this.imagePerson});
